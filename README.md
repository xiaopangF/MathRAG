...
|---|---:|---:|---:|---:|
| 关键词命中 | 86.32% | 100.00% | 100.00% | 0.9263 |
| 页码命中 | 54.74% | 78.95% | 90.53% | 0.6835 |
| 章节命中 | 48.42% | 64.21% | 73.68% | 0.5795 |

说明：

- 总题数 100，其中 95 题可回答、5 题越界拒答。
- 关键词 Recall@5 已达到 100%，说明候选片段基本能召回到答案依据。
- 页码和章节 Recall 仍有明显优化空间，当前报告保留 9 个页码未命中和 25 个章节未命中案例，后续用于修切分器和 metadata 继承。
